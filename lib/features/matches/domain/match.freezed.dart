...
mixin _$TennisMatch {
 ...
 String? get score; String? get winner; String get resultType;// 'normal' or 'walkover'
 String? get categoryName;// Display name of the category
 String? get nextMatchId;// ID of the match where the winner goes
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tournamentId,categoryId,tournamentName,time,court,round,status,durationMinutes,locationId,player1Id,player1Name,const DeepCollectionEquality().hash(player1UserIds),const DeepCollectionEquality().hash(player1AvatarUrls),player2Id,player2Name,const DeepCollectionEquality().hash(player2UserIds),const DeepCollectionEquality().hash(player2AvatarUrls),opponentName,score,winner,resultType,categoryName,nextMatchId,matchIndex,player1Cheers,player2Cheers,player1Confirmed,player2Confirmed,player1Justification,player2Justification]);

@override
String toString() {
  return 'TennisMatch(id: $id, tournamentId: $tournamentId, categoryId: $categoryId, tournamentName: $tournamentName, time: $time, court: $court, round: $round, status: $status, durationMinutes: $durationMinutes, locationId: $locationId, player1Id: $player1Id, player1Name: $player1Name, player1UserIds: $player1UserIds, player1AvatarUrls: $player1AvatarUrls, player2Id: $player2Id, player2Name: $player2Name, player2UserIds: $player2UserIds, player2AvatarUrls: $player2AvatarUrls, opponentName: $opponentName, score: $score, winner: $winner, resultType: $resultType, categoryName: $categoryName, nextMatchId: $nextMatchId, matchIndex: $matchIndex, player1Cheers: $player1Cheers, player2Cheers: $player2Cheers, player1Confirmed: $player1Confirmed, player2Confirmed: $player2Confirmed, player1Justification: $player1Justification, player2Justification: $player2Justification)';
}
...
/// Create a copy of TennisMatch
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? tournamentId = null,Object? categoryId = null,Object? tournamentName = null,Object? time = freezed,Object? court = freezed,Object? round = null,Object? status = null,Object? durationMinutes = null,Object? locationId = freezed,Object? player1Id = null,Object? player1Name = null,Object? player1UserIds = null,Object? player1AvatarUrls = null,Object? player2Id = freezed,Object? player2Name = freezed,Object? player2UserIds = null,Object? player2AvatarUrls = null,Object? opponentName = freezed,Object? score = freezed,Object? winner = freezed,Object? resultType = null,Object? categoryName = freezed,Object? nextMatchId = freezed,Object? matchIndex = null,Object? player1Cheers = null,Object? player2Cheers = null,Object? player1Confirmed = null,Object? player2Confirmed = null,Object? player1Justification = freezed,Object? player2Justification = freezed,}) {
...
class _TennisMatch implements TennisMatch {
  const _TennisMatch({required this.id, required this.tournamentId, required this.categoryId, required this.tournamentName, this.time, this.court, required this.round, required this.status, this.durationMinutes = 90, this.locationId, required this.player1Id, required this.player1Name, final  List<String> player1UserIds = const [], final  List<String?> player1AvatarUrls = const [], this.player2Id, this.player2Name, final  List<String> player2UserIds = const [], final  List<String?> player2AvatarUrls = const [], this.opponentName, this.score, this.winner, this.resultType = 'normal', this.categoryName, this.nextMatchId, this.matchIndex = 0, this.player1Cheers = 0, this.player2Cheers = 0, this.player1Confirmed = false, this.player2Confirmed = false, this.player1Justification, this.player2Justification}): _player1UserIds = player1UserIds,_player1AvatarUrls = player1AvatarUrls,_player2UserIds = player2UserIds,_player2AvatarUrls = player2AvatarUrls;
...
@override@JsonKey() final  String resultType;
// 'normal' or 'walkover'
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tournamentId,categoryId,tournamentName,time,court,round,status,durationMinutes,locationId,player1Id,player1Name,const DeepCollectionEquality().hash(_player1UserIds),const DeepCollectionEquality().hash(_player1AvatarUrls),player2Id,player2Name,const DeepCollectionEquality().hash(_player2UserIds),const DeepCollectionEquality().hash(_player2AvatarUrls),opponentName,score,winner,resultType,categoryName,nextMatchId,matchIndex,player1Cheers,player2Cheers,player1Confirmed,player2Confirmed,player1Justification,player2Justification]);
...
/// Create a copy of TennisMatch
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? tournamentId = null,Object? categoryId = null,Object? tournamentName = null,Object? time = freezed,Object? court = freezed,Object? round = null,Object? status = null,Object? durationMinutes = null,Object? locationId = freezed,Object? player1Id = null,Object? player1Name = null,Object? player1UserIds = null,Object? player1AvatarUrls = null,Object? player2Id = freezed,Object? player2Name = freezed,Object? player2UserIds = null,Object? player2AvatarUrls = null,Object? opponentName = freezed,Object? score = freezed,Object? winner = freezed,Object? resultType = null,Object? categoryName = freezed,Object? nextMatchId = freezed,Object? matchIndex = null,Object? player1Cheers = null,Object? player2Cheers = null,Object? player1Confirmed = null,Object? player2Confirmed = null,Object? player1Justification = freezed,Object? player2Justification = freezed,}) {
