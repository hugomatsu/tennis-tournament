...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tournamentId,categoryId,tournamentName,time,court,round,status,durationMinutes,locationId,player1Id,player1Name,const DeepCollectionEquality().hash(player1UserIds),const DeepCollectionEquality().hash(player1AvatarUrls),player2Id,player2Name,const DeepCollectionEquality().hash(player2UserIds),const DeepCollectionEquality().hash(player2AvatarUrls),opponentName,score,winner,resultType,nextMatchId,matchIndex,player1Cheers,player2Cheers,player1Confirmed,player2Confirmed,player1Justification,player2Justification]);

@override
String toString() {
  return 'TennisMatch(id: $id, tournamentId: $tournamentId, categoryId: $categoryId, tournamentName: $tournamentName, time: $time, court: $court, round: $round, status: $status, durationMinutes: $durationMinutes, locationId: $locationId, player1Id: $player1Id, player1Name: $player1Name, player1UserIds: $player1UserIds, player1AvatarUrls: $player1AvatarUrls, player2Id: $player2Id, player2Name: $player2Name, player2UserIds: $player2UserIds, player2AvatarUrls: $player2AvatarUrls, opponentName: $opponentName, score: $score, winner: $winner, resultType: $resultType, nextMatchId: $nextMatchId, matchIndex: $matchIndex, player1Cheers: $player1Cheers, player2Cheers: $player2Cheers, player1Confirmed: $player1Confirmed, player2Confirmed: $player2Confirmed, player1Justification: $player1Justification, player2Justification: $player2Justification)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tournamentId,categoryId,tournamentName,time,court,round,status,durationMinutes,locationId,player1Id,player1Name,const DeepCollectionEquality().hash(_player1UserIds),const DeepCollectionEquality().hash(_player1AvatarUrls),player2Id,player2Name,const DeepCollectionEquality().hash(_player2UserIds),const DeepCollectionEquality().hash(_player2AvatarUrls),opponentName,score,winner,resultType,nextMatchId,matchIndex,player1Cheers,player2Cheers,player1Confirmed,player2Confirmed,player1Justification,player2Justification]);
